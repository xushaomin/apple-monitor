...
/**
 * Queue for Email Alerts. This queue is used when jManage is not able to
 * deliver emails.
 * 
 * <p>
 * Date: Nov 6, 2005
...
public class EmailAlerts extends PersistedAlerts {
	...
	private static final String EMAIL_ALERTS_FILE = CoreUtils.getDataDir() + File.separator + "email-alerts.xml";
